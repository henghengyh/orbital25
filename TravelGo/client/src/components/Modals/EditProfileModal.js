...
export default function EditProfileModal({ isOpen, onClose, onSave }) {
    ...
    const [form, setForm] = useState({
        ...
        favouriteDestination: user.profileInfo?.favouriteDestination || "",
        ...
        <div className="fixed inset-0 bg-black bg-opacity-40 flex items-center justify-center z-50">
            <div className="bg-white rounded-lg p-6 w-100 shadow-lg">
                ...
                <div className="space-y-3">
                    {inputBox("text", "Name", "newName", form.newName)}
                    {inputBox("text", "Bio", "bio", form.bio)}
                    {inputBox("text", "Favourite Destination", "favouriteDestination", form.favouriteDestination)}
                    {dropdownBox("Gender", "gender", ["Male", "Female", "Other"], form.gender)}
