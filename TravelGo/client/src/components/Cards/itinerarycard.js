...
export default function ItineraryCard({
    ...
    return (
        <div role="article" aria-label={`itinerary card ${tripName}`} onClick={onClick} className="border rounded-lg overflow-hidden bg-mint-green hover:shadow-lg hover:shadow-slate-200 transition-all ease-in-out relative cursor-pointer">
