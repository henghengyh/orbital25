...
const ActivitySchema = new mongoose.Schema({
    ...
    startTime: String,
    endTime: String,
    type: { type: String, enum: typeOfActivities, required: true },
    location: LocationSchema,
    notes: String,
    transport: {
        recommendedTravelTime: { type: Number, default: null },
        modeOfTransport: { type: String, enum: [null, "walk", "car", "public transport"], default: null },
        startLoc: { type: LocationSchema, default: null },
        endLoc: { type: LocationSchema, default: null },
        travelDurationPass: { type: Boolean, default: true }
    },
});
